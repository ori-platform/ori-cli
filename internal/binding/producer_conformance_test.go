...
// typedFrom lifts a published case into the typed document through the
// production decoder, losing every spelling decision; the corpus bytes are the
// independent oracle the rebuilt document is held to.
